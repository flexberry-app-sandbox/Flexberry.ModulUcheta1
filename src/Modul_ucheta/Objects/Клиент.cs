...
namespace IIS.Modul_ucheta
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        /// idКлинета.
        /// </summary>
        // *** Start programmer edit section *** (Клиент.idКлинета CustomAttributes)

        // *** End programmer edit section *** (Клиент.idКлинета CustomAttributes)
        public virtual int idКлинета
        {
            get
            {
                // *** Start programmer edit section *** (Клиент.idКлинета Get start)

                // *** End programmer edit section *** (Клиент.idКлинета Get start)
                int result = this.fidКлинета;
                // *** Start programmer edit section *** (Клиент.idКлинета Get end)

                // *** End programmer edit section *** (Клиент.idКлинета Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Клиент.idКлинета Set start)

                // *** End programmer edit section *** (Клиент.idКлинета Set start)
                this.fidКлинета = value;
                // *** Start programmer edit section *** (Клиент.idКлинета Set end)

                // *** End programmer edit section *** (Клиент.idКлинета Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Modul_ucheta.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Modul_ucheta.Клиент));
                }
            }
        }
    }
