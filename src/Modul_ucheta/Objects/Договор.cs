...
namespace IIS.Modul_ucheta
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta.Статус fСтатус;
        
        private IIS.Modul_ucheta.ТипДоговора fТип;
        ...
        private IIS.Modul_ucheta.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Modul_ucheta.Клиент fКлиент;
        ...
        public virtual IIS.Modul_ucheta.Статус Статус
        {
            get
            {
                ...
                IIS.Modul_ucheta.Статус result = this.fСтатус;
        ...
        public virtual IIS.Modul_ucheta.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Modul_ucheta.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Modul_ucheta.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta.Клиент Клиент
        {
            get
            {
                ...
                IIS.Modul_ucheta.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Modul_ucheta.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Modul_ucheta.Договор));
                }
            }
        }
    }
